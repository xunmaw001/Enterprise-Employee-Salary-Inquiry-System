<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="工资编号" prop="gongzibianhao">
            <el-input v-model="ruleForm.gongzibianhao" 
                placeholder="工资编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gongzibianhao" label="工资编号" prop="gongzibianhao">
              <el-input v-model="ruleForm.gongzibianhao" 
                placeholder="工资编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工资标题" prop="gongzibiaoti">
          <el-input v-model="ruleForm.gongzibiaoti" 
              placeholder="工资标题" clearable  :readonly="ro.gongzibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工资标题" prop="gongzibiaoti">
              <el-input v-model="ruleForm.gongzibiaoti" 
                placeholder="工资标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实发工资" prop="shifagongzi">
          <el-input v-model="ruleForm.shifagongzi" 
              placeholder="实发工资" clearable  :readonly="ro.shifagongzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实发工资" prop="shifagongzi">
              <el-input v-model="ruleForm.shifagongzi" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="工资账单" prop="gongzizhangdan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.gongzizhangdan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongzizhangdan" label="工资账单" prop="gongzizhangdan">
                    <span v-html="ruleForm.gongzizhangdan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	jibengongzi : false,
	shifagongzi : false,
	gongzizhangdan : false,
	yuangongzhanghao : false,
	yuangongxingming : false,
	bumen : false,
      },
      ruleForm: {
        gongzibianhao: this.getUUID(),
        gongzibiaoti: '',
        fengmian: '',
        fafangshijian: '',
        jibengongzi: '',
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='gongzibianhao'){
            this.ruleForm.gongzibianhao = obj[o];
	    this.ro.gongzibianhao = true;
            continue;
          }
          if(o=='gongzibiaoti'){
            this.ruleForm.gongzibiaoti = obj[o];
	    this.ro.gongzibiaoti = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.shifagongzi = true;
          ...
          if(o=='gongzizhangdan'){
            this.ruleForm.gongzizhangdan = obj[o];
	    this.ro.gongzizhangdan = true;
            continue;
          }
	...
	this.ruleForm.gongzizhangdan = this.ruleForm.gongzizhangdan.replace(reg,'../../../ssm6x717/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongzixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongzixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
