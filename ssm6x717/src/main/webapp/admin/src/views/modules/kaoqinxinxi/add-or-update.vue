<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="考勤编号" prop="kaoqinbianhao">
            <el-input v-model="ruleForm.kaoqinbianhao" 
                placeholder="考勤编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaoqinbianhao" label="考勤编号" prop="kaoqinbianhao">
              <el-input v-model="ruleForm.kaoqinbianhao" 
                placeholder="考勤编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考勤标题" prop="kaoqinbiaoti">
          <el-input v-model="ruleForm.kaoqinbiaoti" 
              placeholder="考勤标题" clearable  :readonly="ro.kaoqinbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考勤标题" prop="kaoqinbiaoti">
              <el-input v-model="ruleForm.kaoqinbiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="考勤时间" prop="kaoqinshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaoqinshijian" 
                type="date"
                :readonly="ro.kaoqinshijian"
                placeholder="考勤时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaoqinshijian" label="考勤时间" prop="kaoqinshijian">
              <el-input v-model="ruleForm.kaoqinshijian" 
                placeholder="考勤时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考勤状态" prop="kaoqinzhuangtai">
          <el-select :disabled="ro.kaoqinzhuangtai" v-model="ruleForm.kaoqinzhuangtai" placeholder="请选择考勤状态">
            <el-option
                v-for="(item,index) in kaoqinzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="考勤状态" prop="kaoqinzhuangtai">
	      <el-input v-model="ruleForm.kaoqinzhuangtai"
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="考勤详情" prop="kaoqinxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kaoqinxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kaoqinxiangqing" label="考勤详情" prop="kaoqinxiangqing">
                    <span v-html="ruleForm.kaoqinxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kaoqinxiangqing = this.ruleForm.kaoqinxiangqing.replace(reg,'../../../ssm6x717/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
